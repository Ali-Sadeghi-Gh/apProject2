...
public class ProfessorPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    temporaryScoreButton.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        temporaryScoreActionPerformed(evt);
      }
    });
...
//    mainFrame.repaintFrame();
  ...
  private void coursesListButtonActionPerformed(java.awt.event.ActionEvent evt) {
    mainFrame.setContentPane(new ProfessorPanel(mainFrame, new CoursesListPanel(mainFrame), client));
    mainFrame.repaintFrame();
  }
...
//    mainFrame.setContentPane(new ProfessorPanel(mainFrame, new WeeklySchedulePanel(mainFrame, professor), 0));
//    mainFrame.repaintFrame();
  }
...
//    mainFrame.setContentPane(new ProfessorPanel(mainFrame, new RecommendationListPanel(mainFrame, professor), 0));
//    mainFrame.repaintFrame();
  }
