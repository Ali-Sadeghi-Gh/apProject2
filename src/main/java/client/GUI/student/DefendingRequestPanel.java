...
public class DefendingRequestPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    requestButton.setText(getConfig().getProperty(String.class, "defendingRequestButtonText"));
  ...
  public void update(String result) {
    resultLabel.setText(result.equals("") ? "" : String.format(getConfig().getProperty(String.class, "defendingResultPattern"), result));
  }
