...
public class MinorRequestPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    facultyLabel.setText(getConfig().getProperty(String.class, "targetFacultyLabelText"));

    facultyBox.setMaximumRowCount(10);

    requestButton.setFont(new java.awt.Font("Tahoma", Font.PLAIN, 20)); // NOI18N
    requestButton.setText(getConfig().getProperty(String.class, "minorRequestButtonText"));
