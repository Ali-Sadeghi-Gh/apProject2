...
public class ProfessorTemporaryScoreList extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    temporaryButton.setText(getConfig().getProperty(String.class, "temporaryButtonText"));
    temporaryButton.addActionListener(this::temporaryButtonActionPerformed);

    finalButton.setText(getConfig().getProperty(String.class, "finalButtonText"));
  ...
  private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {
    client.changePanel(PanelName.PROFESSORS_COURSE_LIST, userRole);
  }
  ...
  private void temporaryButtonActionPerformed(java.awt.event.ActionEvent evt) {
    for (int i = 0; i < studentTable.getModel().getRowCount(); i++) {
      if (studentTable.getModel().getValueAt(i, 6) == null ||
        ...
        mainFrame.showMessage(getConfig().getProperty(String.class, "allScoresErrorMessage"));
        return;
      }
    }
    for (int i = 0; i < studentTable.getModel().getRowCount(); i++) {
      try {
        ...
        mainFrame.showMessage(getConfig().getProperty(String.class, "scoreNumErrorMessage"));
        return;
      }
    }
    for (int i = 0; i < studentTable.getModel().getRowCount(); i++) {
      ...
      if (score < 0 || score > 20) {
        mainFrame.showMessage(getConfig().getProperty(String.class, "scoreRangeErrorMessage"));
        return;
      }
    }
  ...
  public void update(String[][] data, String courseName, String courseId, String faculty, String credit, String grade) {
    showData(data);
    nameLabel.setText(String.format(getConfig().getProperty(String.class, "nameLabelText"), courseName));
    idLabel.setText(String.format(getConfig().getProperty(String.class, "idLabelText"), courseId));
    facultyLabel.setText(String.format(getConfig().getProperty(String.class, "facultyLabelText"), faculty));
    creditLabel.setText(String.format(getConfig().getProperty(String.class, "creditLabelText"), credit));
