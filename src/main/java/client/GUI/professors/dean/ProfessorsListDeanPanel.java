...
public class ProfessorsListDeanPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    degreeBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { getConfig().getProperty(String.class, "comboBoxDefault"), Professor.Degree.assistant.name(), Professor.Degree.associate.name(), Professor.Degree.full.name() }));
    ...
    removeProfessorButton.setText(getConfig().getProperty(String.class, "removeProfessorButtonText"));
    removeProfessorButton.addActionListener(this::removeProfessorButtonActionPerformed);

    addProfessorButton.setText(getConfig().getProperty(String.class, "addProfessorButtonText"));
    addProfessorButton.addActionListener(this::addProfessorButtonActionPerformed);

    changeProfessorButton.setText(getConfig().getProperty(String.class, "changeProfessorButtonText"));
