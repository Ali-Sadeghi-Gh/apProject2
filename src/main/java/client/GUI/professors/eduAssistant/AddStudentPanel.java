...
public class AddStudentPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    supervisorLabel.setText(getConfig().getProperty(String.class, "supervisorLabelText"));
    ...
    enteringYearLabel.setText(getConfig().getProperty(String.class, "enteringYearLabelText"));

    statusLabel.setFont(new java.awt.Font("Tahoma", Font.PLAIN, 18)); // NOI18N
    statusLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    statusLabel.setText(getConfig().getProperty(String.class, "statusLabelText"));
  ...
  private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if (supervisorField.getText().equals("")) {
      mainFrame.showMessage(getConfig().getProperty(String.class, "emptySupervisorIdErrorMessage"));
      return;
    }
    if (enteringYearField.getText().equals("")) {
      mainFrame.showMessage(getConfig().getProperty(String.class, "emptyEnteringYearErrorMessage"));
      return;
    }
    ...
    try {
      ...
      mainFrame.showMessage(getConfig().getProperty(String.class, "supervisorIdNumErrorMessage"));
      return;
    }
    try {
      Integer.parseInt(enteringYearField.getText());
    } catch (Exception e) {
      mainFrame.showMessage(getConfig().getProperty(String.class, "enteringYearNumErrorMessage"));
      return;
    }
