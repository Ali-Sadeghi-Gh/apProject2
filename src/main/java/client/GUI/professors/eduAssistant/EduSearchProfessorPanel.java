...
public class EduSearchProfessorPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    professorLabel.setText(getConfig().getProperty(String.class, "professorLabelText1"));
  ...
  public void update(String id, String name, String faculty, String degree, String[][] data) {
    ...
    degreeLabel.setText(String.format(getConfig().getProperty(String.class, "degreeLabelText"), degree));
