...
public class ProfessorsListPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    degreeLabel.setText(getConfig().getProperty(String.class, "degreeLabel"));

    degreeBox.setMaximumRowCount(10);
    degreeBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { getConfig().getProperty(String.class, "comboBoxDefault"),
            Professor.Degree.assistant.name(), Professor.Degree.associate.name(), Professor.Degree.full.name() }));
  ...
  private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {
    client.changeToProfessorsListPanel(userRole, Objects.requireNonNull(facultyBox.getSelectedItem()).toString(),
            nameField.getText(), Objects.requireNonNull(degreeBox.getSelectedItem()).toString());
  }
